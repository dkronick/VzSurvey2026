...
\instruction{Aleatorizar pares de imágenes.}

% TODO: Add images here - you'll need to include the image files and use:
% \begin{figure}[h]
% \centering
% \begin{tabular}{cc}
% \includegraphics[width=0.4\textwidth]{agent1.jpg} & \includegraphics[width=0.4\textwidth]{agent2.jpg} \\
% Agente A & Agente B
% \end{tabular}
% \end{figure}
...
Fuerzas Armadas & \_\_\_\_\_ \\
Iglesia Católica & \_\_\_\_\_ \\
\end{tabular}
...
\begin{responses}
\item Es muy probable que haya elecciones
\item Es algo probable que haya elecciones
\item Es poco probable que haya elecciones
\item Es muy poco probable que haya elecciones
\item[(98)] No sabe [NO LEER]
\item[(99)] No responde [NO LEER]
\end{responses}
